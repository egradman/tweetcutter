...
class Surface(object):
    ...
    @classmethod
    def convert_usersurface(cls, bytestring, usersurface, **kwargs):
        """Convert a SVG document to the format for this class.
        ...
        kwargs['bytestring'] = bytestring
        tree = Tree(**kwargs)
        container = cls(tree, None, dpi, usersurface=usersurface)

    def __init__(self, tree, output, dpi, usersurface=None):
